...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TreeItem.extra_classes'
        db.add_column(u'sitetree_treeitem', 'extra_classes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TreeItem.extra_classes'
        db.delete_column(u'sitetree_treeitem', 'extra_classes')
