...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TreeItem.autohide_branch'
        db.add_column('sitetree_treeitem', 'autohide_branch', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TreeItem.autohide_branch'
        db.delete_column('sitetree_treeitem', 'autohide_branch')
    ...
    models = {
        ...
        'sitetree.treeitem': {
            ...
            'autohide_branch': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
